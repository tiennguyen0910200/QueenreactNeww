      ...
      <React.Fragment>
        ...
        <div>
          <div className="vendorplan">
            <img src={+detailPlan.avatar} alt="" width="450px" height="250px" />
          ...
          <div className="grid-container">
            <div class="item2">
              <div className="khungPlan">
                <textarea
                  className="form-input-plan"
                  placeholder="Viết kế hoạch cho bữa tiệc của bạn và gửi đến chúng tôi.."
                />
              </div>
            </div>
            <div className="food">
              <div>
                <button className="btn-Food">Đồ ăn </button>
                <br></br>
                {this.state.categories21.map((item) => (
                  <div className="flex-item">
                    ...
                    />
                    <label for="">{item.name_product}</label>
                    <br></br>
            ...
            <div className="speaker">
              <div>
                <button className="btn-Speaker">Loa máy </button>
                <br></br>
                {this.state.categories11.map((loa) => (
                  <div className="flex-item">
                    <img
                      className="img-plan"
                      src={"http://127.0.0.1:8000/storage/" + loa.picture}
                    />
                    <label for="">{loa.name_product}</label>
                    <br></br>
                    <input type="checkbox" id="" name="" value="Bike" />
                  </div>
                ))}
            ...
            <div className="cake">
              <div>
                <button className="btn-Cake">Bánh kem </button>
                <br></br>
                {this.state.categories51.map((kem) => (
                  <div className="flex-item">
                    <img
                      className="img-plan"
                      src={"http://127.0.0.1:8000/storage/" + kem.picture}
                    />
                    <label for="">{kem.name_product}</label>
                    <br></br>
                    <input type="checkbox" id="" name="" value="Bike" />
                  </div>
                ))}
            ...
            <div className="deco">
              <div>
                <button className="btn-Deco">Trang trí</button>
                <br></br>
                {this.state.categories31.map((tri) => (
                  <div className="flex-item">
                    <img
                      className="img-plan"
                      src={"http://127.0.0.1:8000/storage/" + tri.picture}
                    />
                    <label for="">{tri.name_product}</label>
                    <br></br>
                    <input type="checkbox" id="" name="" value="Bike" />
                  </div>
                ))}
              </div>
              <button className="btn-Plan">Đặt</button>
            </div>
          </div>
          <br />
          <br />
