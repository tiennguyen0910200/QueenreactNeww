...
class Footer extends Component {
  render() {
    return (
      <Router>
        <div style={{backgroundColor: "black", color: "white", paddingTop: "10px"}}>
          <div class="container">
            <div class="row">
              <div class="col-sm-3">
           ...
           <div>
             ...
             <p>Xin gửi chúng tôi ý tưởng của bạn,báo<br/> cáo lỗi,đề xuất!<br/>Bất kì thông tin phản hồi sẽ được đánh giá cao.</p>
           </div>
              </div>
              <div class="col-sm-3">
              <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d7668.41304705934!2d108.23924267454373!3d16.054769305559233!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1svi!2s!4v1615276754112!5m2!1svi!2s" width="290" height="240"></iframe>
              </div>
            </div>
          </div>
        </div>
